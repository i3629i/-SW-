...
for i in range(len(finger)):
    ...
    # print(circle_size)
    # cv2.circle(frame, (fingerprint_X, fingerprint_Y), circle_size, (255, 255, 0), thickness=1)
    first_X =finger[i][0]
    first_Y = finger[i][1]
    ...
    print(B)
    acos = math.acos( X/B ) * 57.3
    print('acos : ',acos)
   # cos = math.acos()
    cv2.ellipse(frame,(fingerprint_X, fingerprint_Y),(50,20),-acos,0,360,(255,255,0),1)
