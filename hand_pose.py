...
for i in range(nPoints):
    ...
    if prob > threshold :
        ...
        cv2.putText(frameCopy, "{}".format(i), (int(point[0]), int(point[1])), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 0, 255), 2, lineType=cv2.LINE_AA)
...
print(points)
finger = [points[20],points[16],points[12],points[8]]
# Draw Skeleton
